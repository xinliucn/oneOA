...
This project is indexed by GitNexus as **oneOA** (3933 symbols, 5422 relationships, 126 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/oneOA/context` | Codebase overview, check index freshness |
| `gitnexus://repo/oneOA/clusters` | All functional areas |
| `gitnexus://repo/oneOA/processes` | All execution flows |
| `gitnexus://repo/oneOA/process/{name}` | Step-by-step execution trace |
